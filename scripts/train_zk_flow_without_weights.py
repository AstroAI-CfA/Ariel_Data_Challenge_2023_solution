"""
Trains a Zuko Normalising Flow on data without the weights, that is on the input parameters not on the NS samples.
"""
...
hyperparameters = {
    ...
    "transforms": 13,
    "bins": 20,
    "hidden_layers_spline_context": 4,
}
training_parameters = {
    "learning_rate": 1e-3,
...
print(
    f"\nStarting training without weights (true input parameters) of version {config['net']['version']}.{config['net']['iteration-save']}"
)
